...
export default defineConfig({
    ...
    'resources/css/indexCarousel.css',
    'resources/js/cookies.js',

    'resources/css/navbar.css',
    'resources/js/hamburger.js',

    'resources/css/piltlingid.css',
