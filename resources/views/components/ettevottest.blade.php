                ...
                <div class="imgcontainer">
                    <a href="{{ route('soojuspumpade-paigaldus') }}">
                        <img src="" data-src="{{ asset('images/vaikesed/es/es.webp') }}"
                            title="Soojuspumpade paigaldus" alt="Soojuspumpadest">
                    </a>
                </div>
                <div class="text">
                ...
                <div class="imgcontainer">
                    <a href="{{ route('poranda-ja-radiaatorkute') }}">
                        <img src=""
                            ...
                            title="Põranda- ja radiaatorküte" alt="Põranda- ja radiaatorküte">
                    </a>
                </div>
                <div class="text">
            ...
            <div class="ettevottest">
                <div class="imgcontainer">
                    <a href="{{ route('milleks-kutteautomaatika') }}">
                        <img src="" data-src="{{ asset('images/vaikesed/kutteautomaatika/esbe-ara.webp') }}"
                            title="Milleks kütteautomaatika" alt="Milleks kütteautomaatika">
                    </a>
                </div>
                <div class="text">
                ...
                <div class="imgcontainer">
                    <a href="{{ route('kuidas-saasta-kuttekuludelt') }}">
                        <img src=""
                            ...
                            title="Kuidas säästa küttekuludelt" alt="Kuidas säästa küttekuludelt">
                    </a>
                </div>
                <div class="text">
