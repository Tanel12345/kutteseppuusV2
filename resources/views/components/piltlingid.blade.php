 ...
 <section class="piltlingid" id="piltlingid" >
    <div class="piltlingidiv">
        ...
        <div class="piltlink"> 
            <a href="{{ route('index') }}" title="ÕHK-õhk soojuspumbad">
        ...
        <div class="piltlink"> 
            <a href="{{ route('index') }}" title="ÕHK-vesi soojuspumbad">
                <div class="piltlingipilt">
                ...
                <div class="piltlingitekst">
                    <img src="{{ Vite::asset('resources/images/icons/küttesepp.png') }}" alt="Küttesepp" />
                    <h2><a href="{{ route('index') }}" title="Ahjud">ÕHK-vesi soojuspumbad</a></h2>
                </div>
                <ul class="Lisalingid">
                    <li>
                        <a href="{{ route('index') }}" title="ES">
                            <img src="{{ Vite::asset('resources/images/vaikesed/es/Energy Save logo.jpg') }}" alt="Energy Save" />
                            Energy Save
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('index') }}" title="Alpha-InnoTec">
