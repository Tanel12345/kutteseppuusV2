<x-layout 
    :title="'Milleks kütteautomaatika – täpne juhtimine, mugavus ja energiasääst | Küttesepp'"
    :metaDescription="'Kütteautomaatika juhib soojuspumpa, katelt ja küttesüsteemi tööd vastavalt ilmastikule ja hoone vajadusele. Küttesepp paigaldab ja seadistab töökindla kütteautomaatika.'"
    :metaKeywords="'kütteautomaatika, küttesüsteemi juhtimine, küttekõver, ilmastikukompensatsioon, soojuspumba automaatika, katla automaatika, ruumitermostaat, Küttesepp'"
...
<section class="uper" id="uperid">
    <div class="carousel">
        <div class="taustadiv">
            ...
            <img class="taust"
                 src="{{ Vite::asset('resources/images/taustad/kutteautomaatika-taust.webp') }}"
        ...
        <div class="ettevotte">
            <div class="content">
                ...
                <p style="text-align:center; margin-top:20px;">
                    ...
                    <a href="{{ route('soojuspumbad.type', 'ohk-ohk-soojuspumbad') }}">Õhk-õhk soojuspumbad</a>
                    &nbsp;|&nbsp;
                    <a href="{{ route('soojuspumbad.type', 'ohk-vesi-soojuspumbad') }}">Õhk-vesi soojuspumbad</a>
                    &nbsp;|&nbsp;
                    <a href="{{ route('soojuspumbad.type', 'maasoojuspumbad') }}">Maaküte</a>
                    &nbsp;|&nbsp;
                    <a href="{{ route('tahkekutteseadmed.index') }}">Tahkekütteseadmed</a>
                ...
                <div class="faq-container" itemscope itemtype="https://schema.org/FAQPage">
                    ...
                    <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                        <h3 itemprop="name" class="faq-question">
                            <span class="faq-icon">&#10003;</span> Kas Küttesepp seadistab ka olemasoleva automaatika?
                        </h3>
                        <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" class="faq-answer">
                            <p itemprop="text">
