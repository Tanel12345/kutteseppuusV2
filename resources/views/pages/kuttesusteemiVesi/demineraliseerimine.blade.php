<x-layout :title="'Küttevee demineraliseerimine – miks ja millal seda kasutada küttesüsteemis | Küttesepp'" :metaDescription="'Demineraliseeritud küttevesi vastab VDI 2035 nõuetele ning kaitseb küttesüsteemi katlakivi ja korrosiooni eest. Küttesepp selgitab, millal see on vajalik ja kuidas seda õigesti teha.'" :metaKeywords="'küttevee demineraliseerimine,
...
soojuspumba hooldus'" :metaAuthor="'Tanel Sepp'" :robots="'index, follow'" :ogImage="asset('images/serp/kuttesepp-og-demineraliseerimine.webp')"
        ...
        <div class="tootjast">
            <div class="ettevotte">
                <div class="content">
                    ...
                    <p>
                        Küttevee demineraliseerimine tähendab vee puhastamist kõigist lahustunud sooladest ja
                        mineraalidest,
                        mis muidu põhjustaksid süsteemi sees katlakivi, korrosiooni ja muda teket. Kui me lisame siia
                        veel PH ehk happelisuse stabiliseerijat saavutame tulemuseks vee, mis vastab standardile
                        <strong>VDI 2035</strong> – ideaalne keskkond
                        pikaealiseks ja tõrkevabaks küttesüsteemi tööks.
                    </p>

                    <p>
                        Kui küttekontuur täidetakse demineraliseeritud ja aluselise veega, väheneb oluliselt
                        hooldusvajadus, süsteemi efektiivsus püsib kõrge ning soojusvahetid ja pumbad töötavad
                        optimaalselt aastaid.
                    ...
                    <p>
                        ...
                        kloriidioonid, nende konsendratsiooni mõõdetakse elektrijuhtivuse mõõtmise teel. Lisaks tektab
                        probleeme ebapiisav PH tase ja liigse hapniku osakaal. See kokku soojenenud küttesüsteemis
                        sadestub torustikus ja soojusvahetites katlakivina. Samal ajal kiireneb ka korrosioon ja
                        korrosioonijääk, muda. Demineraliseeritud vesi eemaldab need riskid:
                    </p>
                    ...
                    <p>
                        ...
                        Küttesepp mõõdab täitmisvee juhtivuse ja pH enne ja pärast süsteemi täitmist ning vajadusel viib
                        läbi vee ettevalmistuse vastavalt abivahendite
                    ...
                    <p>
                        ...
                        püsiv kaitse. <br>
                        <strong>
                            Hilisem süsteemi juurde täitmine tavalise veega vähendab puhta vee osa süsteemis. Soovitame
                            süsteemile lisada spetsiaalse juurdetäite filtri.
                        </strong>
                    </p>
                    ...
                    <div class="faq-container" itemscope itemtype="https://schema.org/FAQPage">
                        ...
                        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                            ...
                            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"
                                class="faq-answer">
                                <p itemprop="text">
                                    Demineraliseeritud vesi on puhastatud vesi, millest on eemaldatud kõik lahustunud
                                    soolad ja
                                    mineraalid. Selle elektrijuhtivus on väga madal, mistõttu ei teki katlakivi ega
                                    galvanilist
                        ...
                        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                            ...
                            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"
                                class="faq-answer">
                                <p itemprop="text">
                                    Üldiselt mitte. Kui süsteem on hermeetiline ja korrektselt täidetud, püsib vee
                                    kvaliteet
                                    aastaid muutumatuna. Soovitav on siiski kontrollida vee parameetreid iga 1–2 aasta
                                    tagant.
                                </p>
                            </div>
                        </div>
                        ...
                        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                            ...
                            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"
                                ...
                                <p itemprop="text">
                                    ...
                                    korrosiooni ning muda. See võib lühendada süsteemi eluiga ja suurendada energiakulu
                                    märkimisväärselt.
                                </p>
                            </div>
                        </div>
                        ...
                        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                            ...
                            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"
                                class="faq-answer">
                                <p itemprop="text">
                                    Üldjuhul pole vaja – demineraliseeritud vesi tagab piisava kaitse ka ilma
                                    lisanditeta.
                                    Inhibiitoreid kasutatakse eraldiseisvalt kas uutes või vanemates, määrdunud
                                    süsteemides, kus täielikku puhastust
                                    pole võimalik teha.
                                </p>
                            </div>
                        </div>
