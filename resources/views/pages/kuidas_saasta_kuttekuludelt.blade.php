<x-layout :title="'Kuidas säästa küttekuludelt – nutikas juhtimine ja õiged seadistused | Küttesepp'" :metaDescription="'Uuri, kuidas vähendada küttekulusid soojuspumba, kütteautomaatika ja õigete seadistuste abil. Küttesepp aitab optimeerida küttesüsteemi ja hoida raha kokku.'" :metaKeywords="'küttekulude säästmine, kuidas säästa küttekuludelt, kütteautomaatika, soojuspumba seadistamine, küttekõver, energiasääst, Küttesepp'" :metaAuthor="'Tanel Sepp'" :robots="'index, follow'" :viteCssAssets="['resources/css/pages/teenustelehed.css']"
    ...
    <section class="uper" id="uperid">
        <div class="carousel">
            <div class="taustadiv">
                ...
                <img class="taust" src="{{ asset('images/taustad/kuidas-saasta-taust.webp') }}"
                ...
                <div class="content">
                    ...
                    <div class="pildidiv">
                        <img class="tootjastpilt" src=""
                            data-src="{{ asset('images/vaikesed/kuidas-saasta-kuttekuludelt/hoiuporsas.webp') }}"
                    ...
                    <div class="faq-container" itemscope itemtype="https://schema.org/FAQPage">
                        ...
                        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                            ...
                            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"
                                class="faq-answer">
                                <p itemprop="text">
                                    Jah. Teostame küttesüsteemide seadistamist, eelkõige küll seadmetele ja süsteemidele
                                    mida oleme ise paigaldanud või mida tunneme, pakume.
                                </p>
                            </div>
                        </div>
