            ...
            <div class="ettevotte">
                <h2><span>Midea Group</span> - innovatsioon ja tipptase</h2><br>
                    ...
                    <div class="content">
                        ...
                        <p>Midea õhksoojuspumbad pakuvad parimat lahendust soojendamiseks ja jahutamiseks. Kvaliteet, usaldusväärsus ja energiasäästlikkus – ideaalne valik kodu või äri jaoks.</p><br><br>
    
                        <h3>Tegemist on silmatorkava tehnoloogiaettevõttega.</h3><br> 
                        
                        <p>Midea on spetsialiseerunud robootikale, tööstusautomaatikale, HVAC-süsteemidele, kodumasinatele ja intelligentsele logistikale.<br>
                        ...
                        Midea kaubamärgi lubadus on pakkuda üllatavalt sõbralikke lahendusi neile, kes hindavad väikeseid hetki kodus. Hiljuti esitles ettevõte ka oma uut loosungit:</p> <br><h3><strong>Midea –</strong> Tee oma kodu mugavaks.</h3><br>
                        ...
                        <div class="pildidiv" style="justify-self:right; margin-top:55px;">
                            <img class="tootjastpilt" src="" data-src="{{ Vite::asset("resources/images/vaikesed/midea/Midea-xtreme-logo.png") }}" alt="midea xtreme õhksoojuspump">
                        </div><br><br>
    
                        <h3><strong>Midea Oasis OP plus</strong></h3><br>
                        <p>Midea Oasis OP Plus 12 on uusima tehnoloogiaga õhksoojuspump, mis ühendab endas maksimaalse tõhususe, energiasäästlikkuse ja kasutusmugavuse. See sobib suurepäraselt nii Eesti karmidesse talvedesse kui ka suvekuumusse, pakkudes optimaalset kütte- ja jahutuslahendust.</p><br>
                        ...
                        <div class="pildidiv">
                            <img class="tootjastpilt" src="" data-src="{{ Vite::asset("resources/images/vaikesed/midea/midea-OP.png") }}" alt="midea op õhksoojuspump">
                        </div><br><br>
                ...
                <div class="links">
                    ...
                    <div class="kusipakkumist">
                        <a href="{{ route('ohksoojuspumbad.index', ['brand' => 'midea-ohk-ohk-soojuspumbad']) }}#tootesektsioon" title="Midea õhksoojuspumbad" >
                            <p>VAATA TOOTEID</p>
                        </a>
                    </div>
                    
                    <div class="kusipakkumist">
                        <a href="https://www.midea-group.com/about-us" title="Midea - About Us" target="_blank" rel="noopener noreferrer" >
                            <p>MIDEA LEHELE</p>
                        </a>
                    </div>
